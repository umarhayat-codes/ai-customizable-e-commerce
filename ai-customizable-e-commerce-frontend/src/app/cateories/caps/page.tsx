    ...
    <div className="bg-white min-h-screen">
      ...
      <main>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16 ">
            {capsData.map((cap, index) => (
              <CategoryCard
                ...
                onClick={() => handleProductClick(cap.id)}
              />
            ))}
          </div>
        </div>
        ...
        <CustomizeCard
          ...
          heading="Create Your Signature Cap"
          subtext="Choose colors, add logos, adjust details, and preview your cap instantly before you buy."
          buttonText="Customize Your Cap"
          ...
          onClick={() => handleProductClick("skull-sketch-cap")}
          // alignment="center"
        />
      </main>
      <Footer />
