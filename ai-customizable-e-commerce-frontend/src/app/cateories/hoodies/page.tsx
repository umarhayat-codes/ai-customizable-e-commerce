...
import { hoodiesData } from "@/data/products";
      ...
      <main>
        ...
        <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-8 py-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-x-8 gap-y-16 ">
            {hoodiesData.map((hoodie, index) => (
              <CategoryCard
                key={index}
                {...hoodie}
                titleFont="var(--font-poppins)"
                descriptionFont="var(--font-inter)"
                priceFont="var(--font-noto-sans-sc)"
                onClick={() => handleProductClick(hoodie.id)}
              />
            ))}
          </div>
        </div>
        ...
        {/* Customize Section */}
        <CustomizeCard
          image="/images/hoodies/customize-hoodies.png"
          heading="Create Your Perfect Hoodie"
          subtext="Choose your style, add graphics or text, and see your hoodie come to life in real time."
          ...
          onClick={() => handleProductClick("customize-hoodies")}
          // alignment="center"
        />
      </main>
      <Footer />
