...
import { phoneData } from "@/data/products";
    ...
    <div className="bg-white min-h-screen">
      ...
      <main>
        ...
        <section className="w-full">
          <Image
            src="/images/phone/hero-section-phone.png"
        ...
        <CustomizeCard
          ...
          heading="Design Your Perfect Case"
          subtext="Pick your phone model, add your favorite patterns, colors, or text, and see it come to life in real-time."
          ...
          onClick={() => handleProductClick("customize-phone-case")}
        />
      </main>
      <Footer />
    </div>
